...
package simple // import "github.com/hsknx/goreporter/linters/simplecode/simple"
...
import (
	...
	"github.com/hsknx/goreporter/linters/simplecode/lint"
)
	...
	fn1 := func(node ast.Node) bool {
		...
		outer:
			for i, stmt := range block.List {
				...
				_, retIface := f.Pkg.TypesInfo.TypeOf(ret.List[len(ret.List)-1].Type).Underlying().(*types.Interface)
